  ...
  return new Promise(resolve => {
    ...
    const options = {
      ...
      headers: {
        ...
        "User-Agent": $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('./USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;android;9.4.4;10;8336534356236303-7326235626433303;network/wifi;model/M2007J3SC;addressid/138130719;aid/8c54e2607b2eb430;oaid/74c017eeabb09406;osVer/29;appBuild/87076;partner/xiaomi001;eufv/1;jdSupportDarkMode/0;Mozilla/5.0 (Linux; Android 10; M2007J3SC Build/QKQ1.200419.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 MQQBrowser/6.2 TBS/045227 Mobile Safari/537.36"),
      }
    }
