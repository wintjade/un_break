...
export tytpacketId=""
 [task_local]
#推一推
0 0 * * * http://nm66.top/jd_tyt.js, tag=推一推, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
*/
const $ = new Env('推一推');
...
let tytpacketId = '1c58684afc6f4c529511e5c019fad3f7-TWlycm9vbHI!';
      ...
      "Cookie": cookie,
        ...
        $.post(options, async (err, resp, data) => {
            try {
                    ...
                    if(data.code == 0){
                      console.log("成功："+data.data.amount)
